...
test_dir = os.path.join(main_dir, "data")
# if os.path.join(main_dir, "data"):
#     print(os.path.join(main_dir, "data"),"exists")
# else:
#     print(os.path.join(main_dir, "data"),"does not exist")
#     main_dir = "C:/JPMC/DEV/TMP/ds/tools/python3.12/latest/Lib/site-packages/pygame/examples"
